...
# run
# 
random_rates = [ 0.1, 0.049, 0.009, 0.0001, 0 ]
paths = [
    "models.ignore/auto_imitator_hacked_compressed_preprocessing_overfit_0.000294391688.model",
    "models.ignore/auto_imitator_hacked_compressed_preprocessing_overfit_0.000299256463.model",
...
print(f"group\tlearning_rate\tepisodes\trandom\treward\taction:0\taction:1\taction:2\taction:3")
