...
# testing
# 
    # testing_batch_generator = database.load_batch_data("512", epochs=1, batches_per_epoch=300)
...
def train(
    ...
    path = f"models.ignore/auto_imitator_polecart_{base_learning_rate:.12f}.model"
