...
class SplitRootClassifier(nn.Module):
    def __init__(self, **config):
        super(SplitRootClassifier, self).__init__()
        # 
        # options
        # 
        ...
        self.root_loss          = config.get('root_loss'   , True)
        model_parameters = ["input_shape", "latent_shape", "output_shape", "learning_rate", "momentum", "root_loss"]
    ...
    def update_weights(self, batch_of_inputs, batch_of_ideal_outputs, epoch_index, batch_index):
        ...
        # combine loss
        record["loss"] = torch.sqrt(classifier_loss * autoencoder_loss)
